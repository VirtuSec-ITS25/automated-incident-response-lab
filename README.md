...
> **Brief Description:** > An automated infrastructure for distributed security monitoring. This project deploys a Wazuh EDR environment across multiple nodes using Ansible and Vagrant, focusing on active threat detection, real-time file integrity monitoring, and automated incident response.
