...
check "web-agent registered as Active in Manager" "sudo /var/ossec/bin/agent_control -l | grep -i web-agent"
check "db-agent registered as Active in Manager"  "sudo /var/ossec/bin/agent_control -l | grep -i db-agent"
